...
\noindent\textbf{Instructor}: Javier Duarte, \href{mailto:jduarte@ucsd.edu}{jduarte@ucsd.edu}, OH MW 3-4pm, PODEM 1A23, \href{https://ucsd.zoom.us/j/XXX}{Zoom: XXX}\\
...
\emph{Friday 1/10}: \textbf{No class}
...
\emph{Friday 1/17}: \underline{Lecture 05}: Harmonic oscillator
...
\emph{Tuesday 2/18}: \textbf{No lab}

\emph{Wednesday 2/19}: \textbf{No class}

\emph{Thursday 2/20}: \underline{Lab 13}: Midterm help

\emph{Friday 2/21}: \underline{Lecture 17}: MCMC for Feynman path integral (continued); \textbf{Midterm due}
...
\emph{Friday 3/7}: \underline{Lecture 23}: Preview of PHYS 139/239: Machine Learning in Physics
